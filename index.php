  ...
  <nav class="navbar bg-body-tertiary mb-5 shadow fixed-top">
    <div class="container">
      <a class="navbar-brand" href="#" style="font-size : 1.1em;">
        ...
        <strong class="mt-5">MY CRUD</strong>
      </a>
      ...
      <ul class="nav nav-pills">
        ...
        <li class="nav-item">
          <a class="nav-link text-dark-emphasis" href="logout_proccess.php">Logout</a>
        </li>
        </li>
      </ul>
      <!-- AKHIR TAB PILIHAN -->
  ...
  <div class="container mt-4 pt-4">
    ...
    <table class="table table-hover mt-3 mb-5 table-striped">
      ...
      <tbody class="table-group-divider">
        <?php
        $data = mysqli_fetch_all($sql_mahasiswa, MYSQLI_ASSOC); // Assuming $sql_mahasiswa is a valid result set
        ...
        if ($data) { // Check if data is retrieved successfully
          foreach ($data as $result) {
            ...
            <tr>
              ...
              <td>
                <a type="button" class="btn btn-warning" href="add-mhs.php?ubah=<?php echo $result['npm']; ?>"><i
                    class="bi bi-pencil"></i></a>
                <a type="button" class="btn btn-danger" href="load-mhs.php?hapus=<?php echo $result['npm']; ?>"
          ...
          echo "No data found."; // Handle the case where no data is retrieved
        }
        ?>
      ...
      <tbody class="table-group-divider">
        ...
        while ($result = mysqli_fetch_assoc($sql_matakuliah)) {
          ...
          <tr>
            ...
            <td>
              <a type="button" class="btn btn-warning" href="add-mk.php?ubah=<?php echo $result['kodemk']; ?>"><i
                  class="bi bi-pencil"></i></a>
              <a type="button" class="btn btn-danger" href="load-mk.php?hapus=<?php echo $result['kodemk']; ?>"
                onClick="return confirm('apakah anda yakin ingin menghapus data tersebut?')"> <i
                  class="bi bi-trash"></i></a>
            </td>
          </tr>
      ...
      <tbody class="table-group-divider">
        ...
        while ($result = mysqli_fetch_assoc($sql_krs)) {
          ...
          <tr>
            ...
            <td>
              <a type="button" class="btn btn-warning" href="add-krs.php?ubah=<?php echo $result['id']; ?>"><i
                  class="bi bi-pencil"></i> </a>
              <a type="button" class="btn btn-danger" href="load-krs.php?hapus=<?php echo $result['id']; ?>"
                onClick="return confirm('apakah anda yakin ingin menghapus data tersebut?')"> <i class="bi bi-trash"></i>
              </a>
            </td>
          </tr>
          <?php
